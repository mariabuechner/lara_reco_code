...
from ray_tracing_Siddon_v2 import *
...
if __name__ == '__main__':
    ...
    projection_phase = siddon_cone_beam_projection(gradPhantom, ys, s, 
                            shift_detector, alpha, w, Nr, Nc, r, D, 
    ...
    # absorption phantom 
    print 'Loading absorption phantom'
    if phantomUseFile:
    ...
    projection_absorp = siddon_cone_beam_projection(phantom, ys, s, 
                            shift_detector, alpha, w, Nr, Nc, r, D, 
