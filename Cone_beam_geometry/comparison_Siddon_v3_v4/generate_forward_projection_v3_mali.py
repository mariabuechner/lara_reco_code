...
from ray_tracing_Siddon_v3 import *
...
if __name__ == '__main__':
    ...
    print "Computation of phase forward projection Siddon v3"
    projection_phase = siddon_cone_beam_projection(phantomp, ys, s, shift_detector, 
                                             alpha, w, Nr, Nc, r, D, Nxp, Nyp, 
                                             Nzp, dxp, dyp, dzp, bxp, byp, bzp, True)
