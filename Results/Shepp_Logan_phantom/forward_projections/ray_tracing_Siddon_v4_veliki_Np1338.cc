...
int main() {
  ...
  double s[NP];
  double ds = H / NR / R;
  arange(-8.37135414150, -1.408495015419, NP, ds, s);
  Point sp[NP];
  for (int i = 0; i < NP; ++i) {
  ...
  siddon_cone_beam_projection("phantom_1024.h5",
                              sp, s, alpha, w, r, R, D, H, N, d, b, Df,
                              /*dpc=*/false);
  write_to_file("siddon_projections_1024_absorbtion_32_276_1338.h5", Df);
  return 0;
}
